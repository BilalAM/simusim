...
public class TestDriverHeterogenous {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FogNode f1 = createHomogeneousFogNode(1, "f1", 0, 700, 50);
        FogNode f2 = createHomogeneousFogNode(2, "f2", 0, 300, 100);
        FogNode f3 = createHomogeneousFogNode(3, "f3", 1, 500, 100);
        ...
        List<Tuple> testTuples = TestDriverUtils.createTuples(400, randomizer);
        randomizer = new Random(21);
        List<Tuple> testTuples2 = TestDriverUtils.createTuples(400, randomizer);
        randomizer = new Random(22);
        List<Tuple> testTuples3 = TestDriverUtils.createTuples(400, randomizer);
        /**
         * ===================================================================================
         */
